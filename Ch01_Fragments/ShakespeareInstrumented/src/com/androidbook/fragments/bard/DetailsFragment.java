...
public class DetailsFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle icicle) {
    	Log.v(MainActivity.TAG, "in DetailsFragment onViewCreated for View: " + view);
    ...
    public void onViewStateRestored(Bundle icicle) {
    	Log.v(MainActivity.TAG, "in DetailsFragment onViewStateRestored for view hierarchy");
    ...
    public void onSaveInstanceState(Bundle icicle) {
    	Log.v(MainActivity.TAG, "in DetailsFragment onSaveInstanceState. Bundle is " + icicle);
        super.onSaveInstanceState(icicle);
    	if(icicle != null) {
    		Log.v(MainActivity.TAG, "icicle contains the following:");
