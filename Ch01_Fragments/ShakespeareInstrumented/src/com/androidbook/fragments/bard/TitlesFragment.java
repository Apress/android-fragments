...
public class TitlesFragment extends ListFragment {
    ...
    public void onViewCreated(View view, Bundle icicle) {
    	Log.v(MainActivity.TAG, "in TitlesFragment onViewCreated");
    ...
    public void onSaveInstanceState(Bundle icicle) {
    	Log.v(MainActivity.TAG, "in TitlesFragment onSaveInstanceState. Bundle is " + icicle);
    ...
    public void onViewStateRestored(Bundle icicle) {
    	Log.v(MainActivity.TAG, "in TitlesFragment onViewStateRestored");
